...
# Define row_args and col_args as lists of tuples
    col_args = [
    (2,),(3,),(3, 4),(5, 3),(1, 4, 3),(7, 1, 5),(3, 4, 1, 1, 2, 2),(9, 1, 1, 5),(2, 9, 1, 2, 3),(2, 3, 4, 1, 3),(3, 4, 1, 2, 3),
    (3, 4, 1, 1, 5),(2, 4, 1, 1, 2, 2),(2, 7, 1, 5),(2, 2, 1, 1, 2, 3),(1, 13, 3),(2, 5, 1, 3),(2, 6, 5),(2, 5, 7),(2, 5, 4, 2),
    (13, 7),(2, 8, 5),(2, 9, 3),(16,),(2, 2)
]

    row_args = [
    (6,),(6,),(4,),(1,),(11,),(4, 11),(4, 1, 1, 1),(4, 1, 1, 1),(2, 1, 1, 1),(2, 1, 1, 1),(12, 4),(1, 9, 1, 4),(2, 9, 9),(2, 9, 9),
    (2, 1, 1, 9),(1, 1, 1, 9),(20,),(1, 1, 3),(14, 3, 2),(3, 3, 2, 5, 2),(3, 3, 1, 3, 8, 1),(3, 5, 5, 7),(3, 2, 2, 2, 2, 3, 3),
    (5, 5, 5),(3, 3, 3)
]
